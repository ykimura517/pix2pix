...
def main():
    ...
    parser.add_argument('--dataset2', '-d2', default='./data2',
                        help='Directory of image files.') 
    parser.add_argument('--dataset3', '-d3', default='./data3',
                        help='Directory of image files.') 
    ...
    dis = Discriminator(in_ch=4, out_ch=3)
    ...
    train_d = FacadeDataset(args.dataset, args.dataset2, args.dataset3, datas_type = 'train')
    test_d = FacadeDataset(args.dataset, args.dataset2, args.dataset3, datas_type = 'test')
    ...
    trainer.extend(extensions.PlotReport(['enc/loss', 'dec/loss','dis/loss'], x_key='epoch', file_name='loss.png'))
